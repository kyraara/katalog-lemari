                        ...
                        <div className="space-y-6">
                            ...
                            <div className="flex items-start gap-4">
                                ...
                                <div>
                                    ...
                                    <p className="text-zinc-600 dark:text-zinc-400 mt-1">refkysyahputra10@gmail.com</p>
                                </div>
                            </div>
                            ...
                            <div className="flex items-start gap-4">
                                ...
                                <div>
                                    ...
                                    <p className="text-zinc-600 dark:text-zinc-400 mt-1 leading-relaxed">
                                        Jl. Raya desa kedaton, Kedaton Peninjauan Raya<br />
                                        Ogan Komering Ulu, Sumatera Selatan<br />
                                        Indonesia
                                    </p>
                                </div>
                            </div>
